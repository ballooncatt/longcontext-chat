...
# 0,1,2,3,4,5
    ...
    if start is not None and mode == 0:
        ...
        gen_kwargs = dict(  
            ...
            streamer=streamer1,
            convert_position=all_input_attention_mask[:,end:end+length],
            endconvert_position=all_input_attention_mask[:,start+convert_ids.shape[1]:start+convert_ids.shape[1]+length],
            delete_start=start,
            delete_end=end,
...
if __name__ == "__main__":
    ...
    audio_inputs = [
        "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/GLM-4-Voice/input/我的早餐吃了大米，午餐吃了豆浆，晚餐吃了羊排.wav"
    ]
    ...
    log_file = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-fsprisk/fudongjie/GLM-4-Voice/result/0609_0_4.txt"

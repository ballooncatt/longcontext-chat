...
class SelfAttention(torch.nn.Module):
    ...
    def forward(
            ...
            endconvert_rotary_pos_emb=None,delete_start=None,delete_end=None,mode = 0,
    ):
        ...
        if use_cache:
            if kv_cache is None:
                ...
                if delete_start is not None:
                    ...
                    # return torch.zeros_like(query_layer), kv_cache
...
class GLMBlock(torch.nn.Module):
    ...
    def forward(
            self, hidden_states, attention_mask, rotary_pos_emb, kv_cache=None, use_cache=True,
            convert_embeds=None,end_convert_embeds=None,delete_start=None,delete_end=None,mode=0,convert_rotary_pos_emb=None, endconvert_rotary_pos_emb=None,
    ):
        # hidden_states: [s, b, h]
...
class GLMTransformer(torch.nn.Module):
    ...
    def forward(
            ...
            convert_embeds=None,delete_start=None,delete_end=None,mode=None,
    ...
    def forward(
        ...
        if delete_start is None or inputs_embeds.shape[1]==1:
            ...
            hidden_states, presents, all_hidden_states, all_self_attentions = self.encoder(
                ...
                convert_embeds=None,delete_start=delete_start,delete_end=delete_end,end_convert_embeds=None,mode=mode,
            )
...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    def forward(
        ...
        if delete_start is not None:
            print('editing')
        print('transformer_time',end_time-start_time)
